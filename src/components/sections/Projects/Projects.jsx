...
const Projects = () => {
    ...
    return (
        ...
        <>
            ...
            <SEO
                title="Industrial Electrical & Automation Projects | CircuitsES"
                description="Explore electrical control panel, automation and industrial electrical projects engineered, manufactured and delivered by CircuitsES."
                path="/projects"
            />
            <BreadcrumbSchema
                items={[
