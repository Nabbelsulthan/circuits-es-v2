...
const Services = () => {
    ...
    return (
        ...
        <>
            ...
            <SEO
                title="Electrical & Industrial Automation Services | CircuitsES"
                description="CircuitsES provides electrical panel manufacturing, industrial automation, PLC solutions, control panel engineering and customized electrical system services."
                path="/services"
            />
